...
ActiveRecord::Schema.define(version: 2020_11_14_020358) do
  ...
  create_table "communities", options: "ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci", force: :cascade do |t|
    ...
    t.datetime "created_at", precision: 6, null: false
    t.datetime "updated_at", precision: 6, null: false
    t.index ["id", "user_id"], name: "index_communities_on_id_and_user_id", unique: true
    t.index ["user_id"], name: "index_communities_on_user_id"
  end

  create_table "community_relationships", options: "ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci", force: :cascade do |t|
    t.bigint "community_id"
    t.bigint "user_id"
    t.datetime "created_at", precision: 6, null: false
    t.datetime "updated_at", precision: 6, null: false
    t.index ["community_id", "user_id"], name: "index_community_relationships_on_community_id_and_user_id", unique: true
    t.index ["community_id"], name: "index_community_relationships_on_community_id"
    t.index ["user_id"], name: "index_community_relationships_on_user_id"
  end
  ...
  add_foreign_key "community_relationships", "communities"
  add_foreign_key "community_relationships", "users"
